---
name: askmeatsack
description: Creates an askmeatsack.com questionnaire for a human, pastes the answer link, and waits. Use in a live chat or from an unattended job that needs unique questions, files, or IDs from each person. Inspect or edit on the private manage link while nobody has answered.
---
