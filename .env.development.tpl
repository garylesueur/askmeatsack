...
RESEND_API_KEY=op://${OP_VAULT:-mep374l3cpdtzwibf5fswsimbi}/askmeatsack.com Development/RESEND_API_KEY
RESEND_EMAIL_DOMAIN=op://${OP_VAULT:-mep374l3cpdtzwibf5fswsimbi}/askmeatsack.com Development/RESEND_EMAIL_DOMAIN
